...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DRV_ENABLE_Pin|LD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, DRV_MS1_Pin|DRV_MS2_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = DRV_ENABLE_Pin|LD2_Pin;
  ...
  GPIO_InitStruct.Pin = DRV_MS1_Pin|DRV_MS2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = DRV_I1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DRV_I1_GPIO_Port, &GPIO_InitStruct);
